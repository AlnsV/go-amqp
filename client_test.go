...
func TestAMQPClient_GetQueueName(t *testing.T) {
	t.Parallel()
	client := &AMQPClient{}
...
func TestAMQPClient_StartConnection(t *testing.T) {
	t.Parallel()
	_, err := getConn()
	if err != nil {
...
func TestAMQPClient_StartChannel(t *testing.T) {
	t.Parallel()
	client, err := getConn()
	if err != nil {
		t.Errorf("Connection failed, error: %s", err)
...
func TestAMQPClient_SetupQueues(t *testing.T) {
	t.Parallel()
	client, err := getConn()
	if err != nil {
		t.Errorf("Connection failed, error: %s", err)
...
func TestAMQPClient_StartReceiver(t *testing.T) {
	t.Parallel()
	client, err := getConn()
	if err != nil {
...
func TestAMQPClient_SetupDispatcher(t *testing.T) {
	t.Parallel()
	// Regular testing, should work just fine
	client, err := getConn()
	if err != nil {
...
func ExampleAMQPClient_StartReceiver() {
...
func BenchmarkAMQPClient_StartReceiver(b *testing.B) {
